...
.controller('DishDetailController', [
  '$scope', '$stateParams', 'menuFactory', 'favoriteFactory', 'baseURL', 
  ...
  function ($scope, $stateParams, menuFactory, favoriteFactory, baseURL, 
    ...
    $ionicPopover.fromTemplateUrl('templates/dish-detail-popover_3.html', {
      scope: $scope
    ...
    $ionicModal.fromTemplateUrl('templates/dish-comment_3.html', {
      scope: $scope
    }).then(function(modal) {
