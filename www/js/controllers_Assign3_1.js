...
.controller('MenuController', ['$scope', 'menuFactory',
    'favoriteFactory', 'baseURL', '$ionicListDelegate', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast',
    ...
    $scope.addFavorite = function (index) {
        ...
        .controller('DishDetailController', ['$scope', '$stateParams', 'dish','menuFactory', 'favoriteFactory', '$ionicPopover', '$ionicModal', 'baseURL'
            ...
            $ionicPopover.fromTemplateUrl('templates/dishdetailpop.html', {
                scope: $scope
        ...
        .controller('IndexController', ['$scope', 'dish', 'promotion', 'menuFactory', 'promotionFactory', 'corporateFactory', 'baseURL', function ($scope, dish, promotion, menuFactory, promotionFactory, corporateFactory, baseURL) {
            $scope.baseURL = baseURL;
    ...
    'favoriteFactory', 'baseURL', '$ionicListDelegate', '$ionicPopup', '$ionicLoading', '$timeout', function ($scope, dishes, favorites, favoriteFactory
        ...
        console.log('checking favorites ' + favorites.length);
        $scope.dishes = dishes;
